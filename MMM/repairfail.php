...
<div class="rma">
	...
	<br><br>
		...
		<br>
		<br>
		Middels deze email laten wij u weten dat het volgende toestel is afgekeurd door het reparatiecentrum, hierbij gaat het om het volgende toestel:<br>
		<br>
		- <?php echo $_POST["toestel"]; ?><br>
		<br><br>
		De reden dat het toestel is afgekeurd door het reparatiecentrum is als volgt:
		- <?php echo $_POST["reden"]; ?><br>
		<br><br>
		U kunt ervoor kiezen om het toestel alsnog te laten repareren, de kosten die hierbij komen kijken zijn voor u. <br>
		Wilt u dit niet dan wordt het toestel terug gestuurd naar het volgende adres:<br>
